...
<body class="flex flex-col md:flex-row h-screen font-[Poppins]">
  ...
  <div class="w-full md:w-1/2 bg-gray-400 flex flex-col justify-center items-center px-6 sm:px-10 py-10">
    ...
    <form class="w-full max-w-md flex flex-col" method="POST" action="{{ route('login') }}">
      @csrf
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        ...
        <a href="{{ route('register') }}" class="bg-white text-black px-6 py-2 rounded font-semibold hover:bg-indigo-500 transition text-center">REGISTER</a>
      </div>
    </form>
  </div>
