...
<body class="flex flex-col md:flex-row h-screen font-[Poppins]">
  ...
  <div class="w-full md:w-1/2 bg-gray-400 flex flex-col justify-center items-center px-6 sm:px-10 py-10">
    <h2 class="text-white text-2xl sm:text-3xl font-bold mb-6">REGISTER AS TRAINER</h2>
    ...
    <form class="w-full max-w-md flex flex-col" method="POST" action="{{ route('trainer.register.submit') }}">
      @csrf
