...
<div id="mobileMenu" class="md:hidden hidden px-6 pt-2 pb-4 bg-[#1f2937] space-y-4">
  <a href="{{ route('trainee.home') }}" class="block text-white hover:text-blue-400">Home</a>
  <a href="{{ route('trainee.workout') }}" class="block text-white hover:text-blue-400">Workout</a>
  <a href="{{ route('trainee.mealplan') }}" class="block text-white hover:text-blue-400">Mealplan</a>
  <a href="{{ route('trainee.profile') }}" class="block text-white hover:text-blue-400">Profile</a>
  <a href="{{ route('trainee.notification') }}" class="block text-white hover:text-blue-400">Reminder</a>
